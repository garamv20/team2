...
<body>
					...
					<table class="table">
						...
						<tr>
							...
							<td><input type="text" id="u_id" name="u_id" size="10">
								...
								<input type="button" class="mybtn2" value="아이디 중복 확인"
						...
						<tr align="center">
							<td colspan="3" align="center"><input class="mybtn"
								type="button" width="150" value="가입하기" onclick="check_signup()">
	...
	<script type="text/javascript">
		function confirmID() {
			//encodeURI  -> get방식으로 넘길때 한글깨짐 현상 방지하는방법 ! 나중에 로그인확인 이나 결제확인할때 써도될듯!
